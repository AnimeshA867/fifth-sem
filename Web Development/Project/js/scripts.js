    ...
    for (var k = 0; k < expression2.length; k++) {
      if (expression2[k] == "!") {
        if (expression2[k - 1] == ")") {
          ...
          expression2 =
            expression2.substring(0, i) +
            String(ans) +
            expression2.substring(k + 1, expression2.length);
          if (ans == 1 && n != 0 && n != 1) {
            var history = document.getElementById("history");
            history.value +=
              "\n" +
    ...
    for (var k = 0; k < expression2.length; k++) {
      if (expression2[k] == "√") {
        if (expression2[k + 1] == "(") {
          ...
          expression2 =
            expression2.substring(0, k) +
            String(ans) +
            expression2.substring(i + 1, expression2.length);
        } else {
          var i = k + 1;
          while (
            expression2[i] == 0 ||
          ...
          expression2 =
            expression2.substring(0, k) +
            String(ans) +
            expression2.substring(i, expression2.length);
        }
      }
    }
  }
      ...
      if (expression2[k] == "l") {
        if (expression2[k + 3] == "(") {
          ...
          expression2 =
            expression2.substring(0, k) +
            String(ans) +
            expression2.substring(h + 1, expression2.length);
        } else {
          var h = k + 3;
          while (
            expression2[h] == 0 ||
          ...
          expression2 =
            expression2.substring(0, k) +
            String(ans) +
            expression2.substring(h, expression2.length);
        }
      }
    }
  }
...
function back() {
  ...
  if (check == 1 || expression2 == "Error" || expression2 == "NaN") {
    ...
    if (n != "*" && m == "*" && p != "\u00D7" && p != "^") {
      ...
      document.getElementById("expression1").value = v.substring(
        0,
        v.length - 1
      );
    } else if (n != "*" && m == "*" && (p != "\u00D7" || p != "^")) {
